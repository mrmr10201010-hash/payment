...
# Lemon Squeezy Webhook Secret (Set this in Lemon Squeezy dashboard and as env var)
# If not using environment variables, you can hardcode it here for testing
...
def lemonsqueezy_webhook():
    ...
    if event_name == "order_created":
        ...
        if easy_orders_id:
            ...
            # 3. Update status in Easy Orders
